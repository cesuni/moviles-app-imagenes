...
export default function Subir() {
    ...
    return(
        <ScrollView style={{ flex: 1, padding:80, backgroundColor: '#C3DADA', borderColor: 'black' }}>
            <br></br>
            <Text>Carga de Imagenes</Text>
            <br></br>
            <Button title="Subir Imagen" type='outline' onPress={seleccionarImagen}></Button>
            <br></br>
            <br></br>
            <Text>Lista de imagenes</Text>
            <br></br>
            <Button title='Ver imagenes' type='outline'onPress={probarDB}></Button>
